...
% Chemin du fichier 
chemin_fichier = '/home/localadmin/Documents/AnalyseHEP/DATA_Clean/DATA_128_BIP/N2_8_clean.mat';
...
for i = 1:nb_HB
    ...
    if isempty(event_label)
        ...
        chemin_segment = fullfile(chemin_sauvegarde, event_label, ['HB_' event_label '_' num2str(i) '-8.mat']);
